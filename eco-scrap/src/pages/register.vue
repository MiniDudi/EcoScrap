                    ...
                    <v-card-text>
                        ...
                        <v-form @submit.prevent="handleRegister">
                            ...
                            <v-text-field v-model="userData.password" label="Senha" prepend-inner-icon="mdi-lock"
                                ...
                                color="eco-primary" class="mb-6 input-field"></v-text-field>

                            <v-text-field v-model="confirmPassword" label="Confirmar senha"
                                prepend-inner-icon="mdi-lock"
                                :append-inner-icon="showPassword2 ? 'mdi-eye' : 'mdi-eye-off'"
                                :type="showPassword2 ? 'text' : 'password'"
                                @click:append-inner="showPassword2 = !showPassword2" variant="outlined"
                                color="eco-primary" class="mb-6 input-field"></v-text-field>

                            <v-btn type="submit" block color="eco-primary" size="x-large" class="mb-4 eco-btn"
                                elevation="2">
                                Cadastrar
                            </v-btn>
